package gui;
    ...
    public class Main implements AdjustmentListener {
        ...
        private static void createAndShowGUI() {
          ...
          frame.setBounds(20,30,400,250);
          frame.getContentPane().setLayout(null);
          Main app = new Main();
          app.sbar1 = new JScrollBar(java.awt.Adjustable.HORIZONTAL, 127, 1,0,255);
          app.sbar1.setBounds(10,20, 200, 15);
          app.sbar1.setBackground(Color.red);
          app.sbar1.addAdjustmentListener(app);
          frame.getContentPane().add(app.sbar1);
          app.sbar2 = new JScrollBar(java.awt.Adjustable.HORIZONTAL, 127, 1,0,255);
          app.sbar2.setBounds(10,40, 200, 15);
          app.sbar2.setBackground(Color.green);
          app.sbar2.addAdjustmentListener(app);
          frame.getContentPane().add(app.sbar2);
          app.sbar3 = new JScrollBar(java.awt.Adjustable.HORIZONTAL, 127, 1,0,255);
          app.sbar3.setBounds(10,60, 200, 15);
          ...
          app.panel.setBounds(220,20,50,55);
